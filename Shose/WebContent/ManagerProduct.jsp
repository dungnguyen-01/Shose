                        ...
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" onclick="showMess(${o.id})" class="delete" data-toggle="modal"><i class="material-icons"${o.id} data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="clearfix">
                    ...
                    <ul class="pagination">
                        ...
                        <c:forEach begin="1" end="${endP}" var="i">                       
                            <li class="page-item"><a href="manager?index=${i}" class="tao ${tag == i?"active":""} page-link">${i}</a></li>
                            </c:forEach>
